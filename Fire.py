    ...
    def spread_fire(self):
        ...
        for tile in self.fire_list:
            ...
            if x - 1 >= 0 and y - 1 >= 0 and self.all_tiles_dict[x - 1][y - 1] is not None and self.all_tiles_dict[x - 1][
                y - 1].flammable == "Yes":
                print("past1")
                self.all_tiles_dict[x - 1][y - 1].set_on_fire(self.canvas, self.all_tiles_dict[x - 1][y - 1].x * self.width, self.all_tiles_dict[x - 1][y - 1].y*self.height, self.width, self.height, "deep sky blue")
            ...
            if y - 1 >= 0 and self.all_tiles_dict[x][y - 1] is not None and self.all_tiles_dict[x][y - 1].flammable == "Yes":
                print("past2")
                self.all_tiles_dict[x][y - 1].set_on_fire(self.canvas, self.all_tiles_dict[x][y - 1].x * self.width, self.all_tiles_dict[x][y - 1].y*self.height, self.width, self.height, "gold")
            ...
            if x + 1 <= 99 and y - 1 >= 0 and self.all_tiles_dict[x + 1][y - 1] is not None and self.all_tiles_dict[x + 1][
                y - 1].flammable == "Yes":
                print("past3")
                self.all_tiles_dict[x + 1][y - 1].set_on_fire(self.canvas, self.all_tiles_dict[x + 1][y - 1].x * self.width, self.all_tiles_dict[x + 1][y - 1].y*self.height, self.width, self.height, "burlywood4")
                var = self.all_tiles_dict[x + 1][y - 1].x
                var2 = self.all_tiles_dict[x + 1][y - 1].y
                fire_list2.append(self.all_tiles_dict[x + 1][y - 1])
            ...
            if x - 1 >= 0 and self.all_tiles_dict[x - 1][y] is not None and self.all_tiles_dict[x - 1][y].flammable == "Yes":
                print("past4")
                self.all_tiles_dict[x - 1][y].set_on_fire(self.canvas, self.all_tiles_dict[x - 1][y].x * self.width, self.all_tiles_dict[x - 1][y].y*self.height, self.width, self.height, "indian red")
            ...
            if x + 1 <= 99 and self.all_tiles_dict[x + 1][y] is not None and self.all_tiles_dict[x + 1][y].flammable == "Yes":
                print("past5")
                self.all_tiles_dict[x + 1][y].set_on_fire(self.canvas, self.all_tiles_dict[x + 1][y].x * self.width, self.all_tiles_dict[x + 1][y].y*self.height, self.width, self.height, "orange")
                fire_list2.append(self.all_tiles_dict[x + 1][y])
            ...
            if x - 1 >= 0 and y + 1 <= 99 and self.all_tiles_dict[x - 1][y + 1] is not None and self.all_tiles_dict[x - 1][
                y + 1].flammable == "Yes":
                print("past6")
                self.all_tiles_dict[x - 1][y + 1].set_on_fire(self.canvas, self.all_tiles_dict[x - 1][y + 1].x * self.width, self.all_tiles_dict[x - 1][y + 1].y*self.height, self.width, self.height, "hot pink")
                fire_list2.append(self.all_tiles_dict[x - 1][y + 1])

            # same column bottom down
            if y + 1 <= 99 and self.all_tiles_dict[x][y + 1] is not None and self.all_tiles_dict[x][y + 1].flammable == "Yes":
                print("past7")
                self.all_tiles_dict[x][y + 1].set_on_fire(self.canvas, self.all_tiles_dict[x][y + 1].x * self.width, self.all_tiles_dict[x][y + 1].y*self.height, self.width, self.height, "dark violet")
                fire_list2.append(self.all_tiles_dict[x][y + 1])
            ...
            if x + 1 <= 99 and y + 1 <= 99 and self.all_tiles_dict[x + 1][y + 1] is not None and self.all_tiles_dict[x + 1][
                y + 1].flammable == "Yes":
                print("past8")
                self.all_tiles_dict[x + 1][y + 1].set_on_fire(self.canvas, self.all_tiles_dict[x + 1][y + 1].x * self.width,  self.all_tiles_dict[x + 1][y + 1].y*self.height, self.width, self.height, "khaki")
                fire_list2.append(self.all_tiles_dict[x + 1][y + 1])
        self.count += 1
        for tile in self.fire_list:
            print(tile.x, tile.y,)
        ...
        print(self.fire_list)
        if len(self.fire_list) != 0 and self.count < 2:
            self.spread_fire()
